...
This example test the JPA repositories ability to map results into entities projections. When Specifications are used, there's an error I was unable to find it cause.
